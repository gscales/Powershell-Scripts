...
function Invoke-MailboxFolderAttachmentReport {
    param( 
        ...
        [Parameter(Position = 6, Mandatory = $false)] [switch]$IncludeInline
    ...
    Begin {
        ...
        $folderStats = Invoke-ProcessFolder -Folder $ReportFolder -IncludeInline:$IncludeInline.IsPresent -MailboxName $MailboxName 
...
function Invoke-ProcessFolder {
    param(
        ...
        [Parameter(Position = 1, Mandatory = $false)] [switch]$IncludeInline,
    ...
    Process {
        ...
        $rptObj = "" | select MailboxName,FolderPath, TotalFolderItems, TotalFolderItemsSize, TotalItemsNoAttach, TotalItemsNoAttachSize, TotalItemsAttach, TotalItemsAttachSize, TotalFileAttachments, TotalFileAttachmentsSize, TotalItemAttachments, TotalItemAttachmentsSize, LargestAttachmentSize, LargestAttachmentName, ItemAgeStatistics, AttachmentAgeStatistics, AttachmentExtensions
