...
function Get-PinnedEmail  {
 	...
 	Process
	{
        ...
        $Folder = Get-FolderFromPath -FolderPath $FolderPath -SmtpAddress $MailboxName -service $service -archive:$Archive.IsPresent
...
function Get-FolderFromPath{
	...
	process{
        ...
        if($Archive.IsPresent){
            $folderid = new-object Microsoft.Exchange.WebServices.Data.FolderId([Microsoft.Exchange.WebServices.Data.WellKnownFolderName]::ArchiveMsgFolderRoot,$SmtpAddress) 
        }
